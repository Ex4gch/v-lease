...
public class VehiclePanel extends JPanel
{
   ...
   JComboBox<Vehicle> Ttype = new JComboBox<Vehicle>(types);
   JComboBox<String> Tstatus = new JComboBox<String>(statuses);
   ...
   public VehiclePanel(String model, String imgpath, String plateNumber, String status, Vehicle type)
   {
      ...
      Ttype.setSelectedItem(type);
      Trate.setText(type.getRATE() + "");
      TpenaltyRate.setText(type.getEXCESSRATE() + "");
